...
public class OrderListServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String sql = "select a.name as username,realname,b.name as bookname,c.* from users a,hotel b,loanhotel c where a.id=c.users and b.id=c.hotels ";
		String[] args = {"username","realname","bookname","id","users","hotels","price","sumday","begintime","endtime","continueday","continuetime","flag"};
